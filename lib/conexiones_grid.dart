...
class MaquetaData {
  ...
  final IconData icon;
  const MaquetaData({
    required this.nombre, required this.subtitulo, required this.ip,
    required this.estado, required this.senal, required this.latencia,
    required this.ultimaConexion, required this.icon,
  });
}
...
class ConexionesGridApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) => MaterialApp(
        title: 'Conexiones', debugShowCheckedModeBanner: false,
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: const [
                Text('Conexiones', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: kText)),
                SizedBox(height: 3),
            ...
            Expanded(
              child: TabBarView(
                ...
                children: [
                  _buildGrid(),
                  const Center(child: Text('Mapa de red — próximamente',
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(children: [
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text(m.nombre, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: kText)),
        ...
        Row(children: [
          ...
          if (m.estado != ConStatus.desconectado) ...[
            ...
            Row(children: [
              ...
              Text('${m.senal} dBm', style: const TextStyle(fontSize: 11, color: kMuted2)),
            ]),
          ],
        ]),
        ...
        Row(children: [
          ...
          const SizedBox(width: 4),
          Text(m.latencia, style: const TextStyle(fontSize: 11, color: kMuted2)),
          const SizedBox(width: 12),
  ...
  Widget _buildBtn() {
    switch (m.estado) {
      ...
      case ConStatus.conectando:
        return OutlinedButton(
          style: OutlinedButton.styleFrom(foregroundColor: kMuted2,
              side: const BorderSide(color: kBorder),
              padding: const EdgeInsets.symmetric(vertical: 10),
              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(7))),
          onPressed: null,
      ...
      case ConStatus.desconectado:
        return ElevatedButton(
          style: ElevatedButton.styleFrom(backgroundColor: kBlue,
              ...
              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(7))),
          onPressed: () {},
          child: const Text('Conectar', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600)));
    }
  }
}