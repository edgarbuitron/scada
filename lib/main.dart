...
//  Fiel al HTML index.html original
// ============================================================
import 'dart:async';
import 'dart:math';
...
class ScadaMasterApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) => MaterialApp(
        ...
        title: 'SCADA Planta - Hitech INGENIUM',
...
class _ScadaMasterHomeState extends State<ScadaMasterHome> {
  ...
  Future<void> _sendChat() async {
    ...
    // Llamada a la API del HTML original
    await Future.delayed(const Duration(seconds: 1));
    String respuesta;
    try {
      // Simula respuesta del bot (en producción conectar a https://hitech-bot-api.onrender.com/preguntar)
  ...
  String _mockBotResponse(String q) {
    ...
    if (q.contains('sensor'))    return 'Todos los sensores están siendo monitoreados en tiempo real. Cambia al modo Manual para simularlos.';
        ...
        children: [
          ...
          Container(
            ...
            child: Column(children: [
              const Text('HITECH INGENIUM',
                  textAlign: TextAlign.center,
                  style: TextStyle(color: kCyan, fontSize: 18,
                      fontWeight: FontWeight.bold, letterSpacing: 1)),
              const SizedBox(height: 4),
              const Text('SCADA MASTER',
                  textAlign: TextAlign.center,
  ...
  Widget _navItem(String emoji, String label, AppView view) {
    ...
    return AnimatedContainer(
      ...
      child: InkWell(
        onTap: () { setState(() => _currentView = view); Navigator.pop(context); },
        child: Padding(
  ...
  Widget _buildTopBar() => Container(
        ...
        child: Row(
          children: [
            ...
            // Reloj
            Text(_clock,
                style: const TextStyle(color: kCyan, fontSize: 15,
  ...
  Widget _topSelect(String val, Map<String, String> items, ValueChanged<String?> fn) =>
      Container(
        ...
        decoration: BoxDecoration(
          color: kBgDark, border: Border.all(color: kCyan),
  ...
  Widget _buildCurrentView() {
    switch (_currentView) {
      ...
      case AppView.neumatico:  return _buildStationView(AppView.neumatico);
      case AppView.robot:      return _buildStationView(AppView.robot);
      case AppView.maquinado:  return _buildStationView(AppView.maquinado);
      case AppView.prensado:   return _buildStationView(AppView.prensado);
    }
  }
      ...
      SizedBox(
        ...
        child: Container(
          ...
          child: Column(children: [
            ...
            Text(value, style: TextStyle(color: color, fontSize: 30,
                fontWeight: FontWeight.bold)),
          ]),
        ),
      );
  ...
  // GEMELOS DIGITALES
  // ─────────────────────────────────────────────────────────────────────────
  Widget _buildDigitalTwin(AppView v) {
    return Container(
      height: 250,
      decoration: BoxDecoration(
  ...
  Widget _dtBox(double w, double h, String label, bool active,
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: active ? [BoxShadow(color: color.withOpacity(0.5), blurRadius: 15)] : null,
      ),
      child: Text(label, textAlign: TextAlign.center,
          style: TextStyle(
              color: active ? (color == kGreen ? kBgDark : kBgDark) : kTextMain,
  ...
  Widget _buildLogBox(AppView v) => Container(
        height: 140,
        decoration: BoxDecoration(
          color: kBgDark, border: Border.all(color: kBorder),
          borderRadius: BorderRadius.circular(4)),
                  ...
                  Container(
                    ...
                    child: Row(children: [
                      const Text('Hitech Bot 🤖',
                          style: TextStyle(color: kBgDark, fontWeight: FontWeight.bold,
                              fontSize: 14)),
                      const Spacer(),
                      GestureDetector(
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              decoration: const BoxDecoration(
                  border: Border(bottom: BorderSide(color: kBorder))),
              child: Text(title, style: const TextStyle(color: kCyan,
...
// ─── Gráfica de líneas (Chart.js equivalente) ─────────────────────────────────
class _LineChartPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final gridPaint = Paint()
      ..color = kBorder..strokeWidth = 0.5;
    final labelStyle = const TextStyle(color: kTextMuted, fontSize: 9);
    ...
    for (int s = 0; s < dataSets.length; s++) {
      ...
      final lastY = padT + chartH -
          ((data.last - minV) / (maxV - minV)) * chartH;
    ...
    for (int i = 0; i < seriesLabels.length; i++) {
      ...
      final tp = TextPainter(
          text: TextSpan(text: seriesLabels[i],
